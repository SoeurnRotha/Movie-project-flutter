...
class anime3 extends StatefulWidget {
  const anime3({Key? key}) : super(key: key);

  @override
  State<anime3> createState() => _anime3State();
}
final String name = "Ten-year-old Chihiro and her parents end up at an abandoned amusement park inhabited by supernatural beings. Soon, she learns that she must work to free her parents who have been turned into pigs.";
    ...
    child: ListView(
      children: [
        ...
        Padding(padding: EdgeInsets.all(10),
          child:Text(("Spirited Away"),style: TextStyle(fontSize: 30,color: Colors.white,fontFamily: "f1"),),),
        Padding(padding: EdgeInsets.all(10),
          child: Text("July 20, 2001 (Japan)",style: TextStyle(fontFamily: "f1",color: Colors.grey,fontSize: 15),),),
        _AddStar(),
        Padding(
  ...
  _movieImage()=> Container(
    ...
    decoration: BoxDecoration(
        ...
        image: DecorationImage(
            image: AssetImage("images/anime/09.jpg"),
            fit: BoxFit.cover
        )
    ),
  );
